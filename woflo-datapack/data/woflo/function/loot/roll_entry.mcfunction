...
execute if score @s woflo.rng <= @s woflo.tmp run function woflo:loot/roll_rarity
execute if score @s woflo.rng > @s woflo.tmp run scoreboard players set @s woflo.cd 10
