...
# Increment pity counters (only if no pity was triggered)
...
execute unless score @s woflo.pity_c matches 20.. unless score @s woflo.pity_e matches 20.. if score @s woflo.rng matches 0..94 run scoreboard players add @s woflo.pity_e 1
