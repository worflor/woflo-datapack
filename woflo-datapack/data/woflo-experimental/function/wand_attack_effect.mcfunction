## Deprecated: This file previously contained the attack router. It now plays a flair effect and applies magic missile damage.
...
# Magic missile trail and impact
...
# Damage enemies at impact point, attributed to the caster
execute anchored eyes positioned ^ ^ ^4 as @e[type=!player,distance=..3] run damage @s 2 minecraft:magic by @s
